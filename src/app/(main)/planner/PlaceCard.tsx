        ...
        {expanded ? (
          <div className={styles.placeExpanded}>
            <div className={styles.expandedRow}>
              {directionsUrl ? (
                <a href={directionsUrl} target="_blank" rel="noopener" className={styles.kakaoDirectionsBtn}>
                  카카오맵에서 길찾기
                </a>
              ) : (
              ...
              <button type="button" className={styles.categoryBtn} onClick={() => handlers.onOpenCategory(place.id)}>
                {place.category}
              </button>
            </div>
            <div className={styles.memoRow}>
              ...
              />
              <button type="button" className={styles.memoSaveBtn} onClick={() => handlers.onSaveMemo(place.id)}>
                {memoSaved ? '저장됨 ✓' : '저장'}
              </button>
            </div>
